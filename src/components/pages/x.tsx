...
//     let compCoords: { row: number; col: number } | null = null;
//     let statsCoords: { row: number; col: number } | null = null;
...
//       console.log('Upload approval triggered, user:', user?.id, 'file:', uploadPreviewFile?.name);
