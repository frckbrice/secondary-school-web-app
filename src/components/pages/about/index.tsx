  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('https://images.unsplash.com/photo-1562774053-701939374585?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&h=1080')`,
          ...
          <div className="bg-black/40 backdrop-blur-md rounded-3xl p-8 md:p-12 border border-white/20">
            <div className="grid lg:grid-cols-3 gap-8 items-center">
              ...
              <div className="lg:col-span-1 flex justify-center">
                <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-blue-300/50 shadow-2xl">
                  <Image
              ...
              <div className="lg:col-span-2 text-center lg:text-left">
                <Quote className="w-12 h-12 mx-auto lg:mx-0 mb-6 text-blue-300" />
                <blockquote className="text-lg md:text-xl leading-relaxed mb-6 italic font-light">
          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-16">
            <div>
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  {language === 'fr'
                    ? "Établi en 1978, le Lycée Bilingue de Bafia a été un phare d'excellence éducative dans la Région du Centre du Cameroun. Notre école a été fondée avec la vision de fournir une éducation bilingue de qualité qui prépare les étudiants aux opportunités nationales et internationales."
                    : 'Established in 1978, Government Bilingual High School Bafia has been a beacon of educational excellence in the Centre Region of Cameroon. Our school was founded with the vision of providing quality bilingual education that prepares students for both national and international opportunities.'}
                </p>
                <p>
                  {language === 'fr'
                ...
                <p>
                  {language === 'fr'
                    ? "Aujourd'hui, GBHS Bafia continue d'innover dans l'éducation tout en maintenant nos valeurs fondamentales d'intégrité, d'excellence et de respect de la diversité. Nous sommes fiers de nos diplômés qui ont apporté des contributions significatives dans divers domaines à travers le Cameroun et au-delà."
                    : 'Today, GBHS Bafia continues to innovate in education while maintaining our core values of integrity, excellence, and respect for diversity. We are proud of our graduates who have gone on to make significant contributions in various fields across Cameroon and beyond.'}
                </p>
              </div>
            </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="flex items-start space-x-4 p-4 bg-purple-50 dark:bg-purple-950/20 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      <span className="font-medium">Mon - Fri:</span> 7:00 AM -
                      15:30 PM
                      <br />
                      <span className="font-medium">Sat:</span> Book an
                      appointment
                    </p>
                  </div>
                </div>
